...
declare -A SCRIPTS=(
    ["BulkCreateUsers"]="$ROOT/Tools/create_users.sh"
    ["BulkDeleteUsers"]="$ROOT/Tools/bulk_delete_users.sh"
    ["BulkAssignDepartments"]="$ROOT/Tools/create_users_departments.sh"
    ["CreateProjectFiles"]="$ROOT/Tools/create_project_files.sh"
    ["ArchiveOldLogs"]="$ROOT/Tools/log_manager.sh"
    ["CompressBackup"]="$ROOT/Tools/backup_orgdata.sh"
    ["SystemHealthChecks"]="$ROOT/Tools/system_health.sh"
)
